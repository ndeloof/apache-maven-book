...
encart. Ces encarts sont reconnaissables au logo : image:Maven3.png[Maven3,align="center"] 
...
projet link:#_ftn1[[1]], ses nombreux plugins et son
wiki link:#_ftn2[[2]]. Pourtant, il existe désormais deux ouvrages en
anglais disponibles gratuitement sur la Toile pour combler ces manques :
_Better Builds with Maven_ link:#_ftn3[[3]], publié en 2006, et _Maven :
The Definitive Guide_ link:#_ftn4[[4]], publié en 2007 et régulièrement
...
SUN link:#_ftn6[[6]] donne un fichier ZIP contenant à la fois les
...
pervers link:#_ftn7[[7]]. Comment se fait-il que cette erreur
...
« WTF ? » comme on dit outre-atlantique link:#_ftn8[[8]], ce que nous ne
...
1.2 link:#_ftn10[[10]]. Par contre, sur le JDK Java 6, cette valeur par
...
devons consulter la documentation du plugin link:#_ftn12[[12]] pour
...
En consultant la documentation en ligne de Groovy link:#_ftn13[[13]],
...
En consultant la documentation du plugin GWT link:#_ftn14[[14]], nous
...
complète dans la documentation en ligne de Maven link:#_ftn15[[15]].
...
un plugin Maven, le projet Flex-mojos link:#_ftn16[[16]], qui prend en
...
accessible sur le site de Maven link:#_ftn18[[18]].
...
commons-beanutils link:#_ftn19[[19]] qui fait ce travail pour nous en une
...
Java, dont le plus connu d'entre eux est jUnit link:#_ftn20[[20]].
...
nombreuses méthodes agiles link:#_ftn21[[21]]. Sa mise en œuvre efficace
...
Nous utilisons Fitnesse  link:#_ftn22[[22]] pour définir nos tests
...
plugin Maven link:#_ftn23[[23]] permettant d'exécuter nos tests Fitnesse
...
Nous faisons appel à jMeter link:#_ftn24[[24]], outil de la fondation
...
Une fois encore, nous faisons appel à un plugin Maven link:#_ftn25[[25]]
...
données sur votre serveur bi-processeur quad-core link:#_ftn26[[26]]
...
accessible au format Maven1 link:#_ftn27[[27]].
...
Archiva link:#_ftn28[[28]]. Cet outil n'est pas seul dans cette catégorie
et doit faire face à la concurrence de Nexus link:#_ftn29[[29]] ainsi que
d'Artifactory link:#_ftn30[[30]]. Tous sont disponibles en open-source,
...
disponible sur le site de SUN link:#_ftn31[[31]].
...
Selenium link:#_ftn32[[32]] est un outil qui n'est pas limité au monde
...
Cargo link:#_ftn33[[33]] est un autre outil majeur pour notre boîte à
...
Ce plugin pour Eclipse a son pendant pour Maven link:#_ftn34[[34]],
...
GlassFish link:#_ftn35[[35]], qui propose un mode de fonctionnement
...
l'environnement de développement éponyme : m2eclipse link:#_ftn36[[36]]
et q4e (rebaptisé pour l'occasion IAM link:#_ftn37[[37]]).
...
POJO link:#_ftn38[[38]] qui a fait le succès des bibliothèques Spring et
...
Maven utilise le conteneur Plexus link:#_ftn39[[39]] pour l'exécution de
...
dépendances link:#_ftn40[[40]] (eh oui, bien que méconnu, Plexus était
...
plugins, Maven repose sur la bibliothèque ClassWorlds link:#_ftn41[[41]].
...
sous-composant spécialisé, Doxia link:#_ftn42[[42]]. Cet outil prend en
...
Sonar link:#_ftn44[[44]] est une application web qui va stocker dans une
...
plugin buildnumber link:#_ftn45[[45]] n'est pas très performant).
...
utilise l'algorithme GPG link:#_ftn46[[46]], qui a le double avantage
...
plutôt optimistes, et l'adoption de Scrum link:#_ftn48[[48]] pour
...
(vous pouvez toujours lire ce petit guide link:#_ftn49[[49]]), et
...
que des utilisateurs sur l'IRC link:#_ftn50[[50]] (serveur
...
Maven link:#_ftn51[[51]], ainsi qu'une FAQ link:#_ftn52[[52]] bien
remplie.
...
Builds with Maven_ link:#_ftn53[[53]] et _Maven – the definitive
...
EasyAnt link:#_ftn55[[55]], comme son nom le suggère, vise à simplifier
...
Gradle link:#_ftn56[[56]] s’appuie lui aussi sur Ant et Ivy, et met en
...
en ligne link:#_ftn57[[57]] est très complète si cette alternative vous
...
d'Ant, il existe aussi le projet Buildr link:#_ftn58[[58]], se
...
Maven edition link:#_ftn59[[59]].  On prend votre outillage existant,
...
société SpringSource link:#_ftn60[[60]]. L'excellente équipe de
...
Aether link:#_ftn61[[61]], hébergé en open-source dans sa propre forge,
et contribué à la fondation Eclipse. Il en est de même de
Sisu link:#_ftn62[[62]], qui permet à Maven3 de fonctionner sur la base
...
quelques personnes. L'équipe complète link:#_ftn63[[63]] compte des
...
bnd link:#_ftn64[[64]], qui génère le MANIFEST OSGi à partir d’un projet
...
pde-maven-plugin link:#_ftn65[[65]] du projet Mojo. Ce plugin lance
...
Nous faisons ainsi la connaissance de Mark link:#_ftn66[[66]], ingénieur
...
jigsaw link:#_ftn67[[67]], et la commande jmod destinée à rejoindre le
...
vers spring:2.0.8:tiger link:#_ftn68[[68]] à la place de spring:2.0.8.
...
L'application maxiMaousse link:#_ftn69[[69]], elle aussi basée sur Maven,
...
Matrice link:#_ftn70[_*[70]*_], surtout en mode crypté (de toute façon,
...
pouvez consulter en ligne link:#_ftn71[[71]], il suffit de lancer la
...
XWiki link:#_ftn72[[72]], un wiki d'entreprise de deuxième génération
...
Maven link:#_ftn76[[76]] ainsi que sur ceux des
plugins link:#_ftn77[[77]]. Vous pouvez d'ailleurs contribuer aux
...
d'autres produits comme Confluence link:#_ftn78[[78]], un Wiki très
réputé.
...
diffusions en fonction des sous projets de Maven link:#_ftn79[[79]].
Enfin, en cas de besoin urgent, vous pouvez essayer de contacter une
partie de l'équipe de développement sur irc link:#_ftn80[[80]].
...
Server link:#_ftn81[[81]], qui est une adaptation du serveur HTTP
d'Apache.
...
Mojo est aussi le nom d'un projet link:#_ftn83[[83]] offrant une
...
référentiels comme Archiva link:#_ftn85[[85]], Nexus link:#_ftn86[[86]],
Artifactory link:#_ftn87[[87]]...
...
serveurs. Un schéma XML est disponible link:#_ftn89[[89]] pour vous aider
...
SureFire link:#_ftn90[[90]]

Maven supporte plusieurs outils de test unitaire :
jUnit link:#_ftn91[[91]] 3 ou 4 et testNG link:#_ftn92[[92]]. Ce support
...
Eclipse link:#_ftn102[[102]] est l'un des utilisateurs d'OSGi le plus
connu (basé sur l'implémentation OSGi Equinox link:#_ftn103[_*[103]*_]).
Maven entre en concurrence directe avec OSGi pour la déclaration des
dépendances et la gestion de leurs conflits. Nexus link:#_ftn104[[104]]
...
Confluence link:#_ftn105[[105]] comme Wiki.

Xdoc link:#_ftn106[[106]]
